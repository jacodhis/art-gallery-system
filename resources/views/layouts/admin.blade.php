        ...
        <div class="sidebar-wrapper" id="sidebar-wrapper">
            <ul class="nav">
                ...
                <a  class="dropdown-toggle"
                          data-toggle="dropdown"> <i class="now-ui-icons ui-1_bell-53"></i>Charts </a>
                        <ul class="dropdown-menu">
                        <a href="#"> <li class="dropdown-item"> user charts </li></a>
                        <a href="#"><li class="dropdown-item">artist charts</li></a>
